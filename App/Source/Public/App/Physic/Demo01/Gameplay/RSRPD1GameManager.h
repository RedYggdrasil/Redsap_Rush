...
namespace RSRush
{
	...
	protected:
		virtual std::shared_ptr<RSRush::PlayerController> MakeSharedPCInstance() override { return PlayerController::CreatePlayerController<RSRush::RSRPD1PlayerController>(LockSelf<RSRPD1GameManager>()); }
