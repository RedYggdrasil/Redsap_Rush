...
RSRSObjectInstance::RSRSObjectInstance(RSRush::RSRSharedMesh3DPtr InMesh, const RSRTransform& InTransform, InstanceDatas&& InInstanceData, const mds::RAssetAuthority InMainMeshAuthority, const bool bInIsHandledAsSObject, const bool bInIsDrawnAsInstance)
	:RSRSObject(InMainMeshAuthority, bInIsHandledAsSObject, bInIsDrawnAsInstance), m_instanceData(std::move(InInstanceData))
{
...
RSRSObjectInstance::RSRSObjectInstance(RSRush::RSRSharedMesh3DPtr InMesh, const RSRTransform& InTransform, InstanceDatas&& InInstanceData)
	:RSRSObjectInstance(InMesh, InTransform, std::move(InInstanceData), mds::RAssetAuthority::None, true, true)
{
}

RSRSObjectInstance::RSRSObjectInstance(RSRush::RSRSharedMesh3DPtr InMesh, InstanceDatas&& InInstanceData)
	:RSRSObjectInstance(InMesh, mds::TRS_IDENTITY, std::move(InInstanceData), mds::RAssetAuthority::None, true, true)
{
}
