...
RSR3DDebugPSO::RSR3DDebugPSO(RSRProgramInstance* InProgramInstance)
	: RSR3DDebugPSO(InProgramInstance, std::make_shared<Shader>(EShaderName::BasicRootSignatureDebugPhysic), std::make_shared<Shader>(EShaderName::basicVSDebugPhysicShader), std::make_shared<Shader>(EShaderName::basicPSDebugPhysicShader))
{

}

RSR3DDebugPSO::RSR3DDebugPSO(RSRProgramInstance* InProgramInstance, std::shared_ptr<Shader> InRootSigShader, std::shared_ptr<Shader> InVertexShader, const std::shared_ptr<Shader> InPixelShader)
